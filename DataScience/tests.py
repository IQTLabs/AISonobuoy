...
class TestAisAudioLabeler:
    ...
    def test_get_shp_dataframe(self, shp_test_data, data_home, source):
        shp = aal.get_shp_dataframe(data_home, source)
    ...
    # def test_augment_ais_data_consistency(self, source, hydrophone, ais_test_data, hmd_test_data, shp_test_data):
        ais, hmd, shp = aal.augment_ais_data(source, hydrophone, ais_test_data, hmd_test_data)
        assert shp == shp_test_data
        assert ais.equals(ais_test_data)
        assert hmd.equals(hmd_test_data)


    def test_augment_ais_data_status(self, source, hydrophone, ais_forced_status_test_data, hmd_test_data):
        ais, hmd, shp = aal.augment_ais_data(source, hydrophone, ais_forced_status_test_data, hmd_test_data)
        shp_expected = {'17261435f7264540b3f640b0cb95b0b5':
            {
                'Moored': [(1645543046, 1645545747), (1645682727, 1645682727), (1645734026, 1645734026),
                           (1645746685, 1645746767), (1645746906, 1645746906)],
                'AtAnchor': [(1645547005, 1645556007), (1645630348, 1645630348), (1645746487, 1645746575),
                             (1645746636, 1645746676), (1645746776, 1645746896)],
                'UnderWayUsingEngine': [(1645558526, 1645558526), (1645683629, 1645733846), (1645737449, 1645746476),
                                        (1645746585, 1645746626), (1645746999, 1645747046)],
